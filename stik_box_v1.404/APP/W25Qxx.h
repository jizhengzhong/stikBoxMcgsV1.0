...
#define __W25QXX_H
 ...
 #include "main.h"
 #include "cmsis_os.h"
#define CS_DISENABLE        HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12, GPIO_PIN_SET);HAL_Delay(10);    //CS无效信号
#define CS_ENABLE     HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12, GPIO_PIN_RESET); HAL_Delay(10);  //CS有效信号
