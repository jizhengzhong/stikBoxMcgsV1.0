...
//////////////////////////ji_add_end/////////////////
    ...
    void Eeprom_Reads(uint8_t sla, uint16_t suba, uint8_t * pBuff,uint16_t NumToRead);
    uint8_t Nw_eep_Rcv_One_Byte(uint8_t sla, uint16_t suba );
#undef IIC_EXT
