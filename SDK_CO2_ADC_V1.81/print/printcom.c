...
static void PtComSndEnable(uint8_t xTxEnable);
static void PtComRcvEnable(uint8_t xRxEnable);


static COM_MAN_Type PtCom;

#define COM                       UART8
#define ComIRQn                   UART8_IRQn
#define PortMan   PtCom
...
*****************************************************************************/
__STATIC_INLINE void PtComTimerEnable(void) {
    PortMan.TimeCnt=0;
    PortMan.bTimerOn = 1;
}
...
__STATIC_INLINE void PtComTimerDisable(void) {
    PortMan.bTimerOn = 0;
}
...
void PtComInit(uint32_t ulBaudRate, ComParity_t eParity) {
    ...
    PtComSndEnable(ENABLE);
    PtComRcvEnable(ENABLE);
